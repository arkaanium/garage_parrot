...
<html lang="fr">
    ...
    <body>
        ...
        <div class="container">
            <br>
            <h1 class="text-center">POLITIQUE DE CONFIDENTIALITE</h1>

            <p>Le site web Garage V.Parrot est détenu par Garage V.Parrot, qui est un contrôleur de données de vos données personnelles.
            Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par Garage V.Parrot, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de Garage V.Parrot.
            ...
            - Les droits relatifs à la prise de décision automatisée et au profilage.<br>
            ...
            <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à teodor.hervier@gmail.com.</p>
        </div>
